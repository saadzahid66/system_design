...
module Kvazaar_QSYS_hps_0 #(
		...
		input  wire [31:0] f2h_sdram1_ARADDR,        //     f2h_sdram1_data.araddr
		input  wire [3:0]  f2h_sdram1_ARLEN,         //                    .arlen
		input  wire [7:0]  f2h_sdram1_ARID,          //                    .arid
		input  wire [2:0]  f2h_sdram1_ARSIZE,        //                    .arsize
		input  wire [1:0]  f2h_sdram1_ARBURST,       //                    .arburst
		input  wire [1:0]  f2h_sdram1_ARLOCK,        //                    .arlock
		input  wire [2:0]  f2h_sdram1_ARPROT,        //                    .arprot
		input  wire        f2h_sdram1_ARVALID,       //                    .arvalid
		input  wire [3:0]  f2h_sdram1_ARCACHE,       //                    .arcache
		input  wire [31:0] f2h_sdram1_AWADDR,        //                    .awaddr
		input  wire [3:0]  f2h_sdram1_AWLEN,         //                    .awlen
		input  wire [7:0]  f2h_sdram1_AWID,          //                    .awid
		input  wire [2:0]  f2h_sdram1_AWSIZE,        //                    .awsize
		input  wire [1:0]  f2h_sdram1_AWBURST,       //                    .awburst
		input  wire [1:0]  f2h_sdram1_AWLOCK,        //                    .awlock
		input  wire [2:0]  f2h_sdram1_AWPROT,        //                    .awprot
		input  wire        f2h_sdram1_AWVALID,       //                    .awvalid
		input  wire [3:0]  f2h_sdram1_AWCACHE,       //                    .awcache
		output wire [1:0]  f2h_sdram1_BRESP,         //                    .bresp
		output wire [7:0]  f2h_sdram1_BID,           //                    .bid
		output wire        f2h_sdram1_BVALID,        //                    .bvalid
		input  wire        f2h_sdram1_BREADY,        //                    .bready
		output wire        f2h_sdram1_ARREADY,       //                    .arready
		output wire        f2h_sdram1_AWREADY,       //                    .awready
		input  wire        f2h_sdram1_RREADY,        //                    .rready
		output wire [63:0] f2h_sdram1_RDATA,         //                    .rdata
		output wire [1:0]  f2h_sdram1_RRESP,         //                    .rresp
		output wire        f2h_sdram1_RLAST,         //                    .rlast
		output wire [7:0]  f2h_sdram1_RID,           //                    .rid
		output wire        f2h_sdram1_RVALID,        //                    .rvalid
		input  wire        f2h_sdram1_WLAST,         //                    .wlast
		input  wire        f2h_sdram1_WVALID,        //                    .wvalid
		input  wire [63:0] f2h_sdram1_WDATA,         //                    .wdata
		input  wire [7:0]  f2h_sdram1_WSTRB,         //                    .wstrb
		output wire        f2h_sdram1_WREADY,        //                    .wready
		input  wire [7:0]  f2h_sdram1_WID,           //                    .wid
		input  wire        f2h_sdram1_clk,           //    f2h_sdram1_clock.clk
		input  wire [31:0] f2h_sdram2_ARADDR,        //     f2h_sdram2_data.araddr
		input  wire [3:0]  f2h_sdram2_ARLEN,         //                    .arlen
		input  wire [7:0]  f2h_sdram2_ARID,          //                    .arid
		input  wire [2:0]  f2h_sdram2_ARSIZE,        //                    .arsize
		input  wire [1:0]  f2h_sdram2_ARBURST,       //                    .arburst
		input  wire [1:0]  f2h_sdram2_ARLOCK,        //                    .arlock
		input  wire [2:0]  f2h_sdram2_ARPROT,        //                    .arprot
		input  wire        f2h_sdram2_ARVALID,       //                    .arvalid
		input  wire [3:0]  f2h_sdram2_ARCACHE,       //                    .arcache
		input  wire [31:0] f2h_sdram2_AWADDR,        //                    .awaddr
		input  wire [3:0]  f2h_sdram2_AWLEN,         //                    .awlen
		input  wire [7:0]  f2h_sdram2_AWID,          //                    .awid
		input  wire [2:0]  f2h_sdram2_AWSIZE,        //                    .awsize
		input  wire [1:0]  f2h_sdram2_AWBURST,       //                    .awburst
		input  wire [1:0]  f2h_sdram2_AWLOCK,        //                    .awlock
		input  wire [2:0]  f2h_sdram2_AWPROT,        //                    .awprot
		input  wire        f2h_sdram2_AWVALID,       //                    .awvalid
		input  wire [3:0]  f2h_sdram2_AWCACHE,       //                    .awcache
		output wire [1:0]  f2h_sdram2_BRESP,         //                    .bresp
		output wire [7:0]  f2h_sdram2_BID,           //                    .bid
		output wire        f2h_sdram2_BVALID,        //                    .bvalid
		input  wire        f2h_sdram2_BREADY,        //                    .bready
		output wire        f2h_sdram2_ARREADY,       //                    .arready
		output wire        f2h_sdram2_AWREADY,       //                    .awready
		input  wire        f2h_sdram2_RREADY,        //                    .rready
		output wire [63:0] f2h_sdram2_RDATA,         //                    .rdata
		output wire [1:0]  f2h_sdram2_RRESP,         //                    .rresp
		output wire        f2h_sdram2_RLAST,         //                    .rlast
		output wire [7:0]  f2h_sdram2_RID,           //                    .rid
		output wire        f2h_sdram2_RVALID,        //                    .rvalid
		input  wire        f2h_sdram2_WLAST,         //                    .wlast
		input  wire        f2h_sdram2_WVALID,        //                    .wvalid
		input  wire [63:0] f2h_sdram2_WDATA,         //                    .wdata
		input  wire [7:0]  f2h_sdram2_WSTRB,         //                    .wstrb
		output wire        f2h_sdram2_WREADY,        //                    .wready
		input  wire [7:0]  f2h_sdram2_WID,           //                    .wid
	...
	Kvazaar_QSYS_hps_0_fpga_interfaces fpga_interfaces (
		...
		.f2h_sdram1_ARADDR  (f2h_sdram1_ARADDR),  //     f2h_sdram1_data.araddr
		.f2h_sdram1_ARLEN   (f2h_sdram1_ARLEN),   //                    .arlen
		.f2h_sdram1_ARID    (f2h_sdram1_ARID),    //                    .arid
		.f2h_sdram1_ARSIZE  (f2h_sdram1_ARSIZE),  //                    .arsize
		.f2h_sdram1_ARBURST (f2h_sdram1_ARBURST), //                    .arburst
		.f2h_sdram1_ARLOCK  (f2h_sdram1_ARLOCK),  //                    .arlock
		.f2h_sdram1_ARPROT  (f2h_sdram1_ARPROT),  //                    .arprot
		.f2h_sdram1_ARVALID (f2h_sdram1_ARVALID), //                    .arvalid
		.f2h_sdram1_ARCACHE (f2h_sdram1_ARCACHE), //                    .arcache
		.f2h_sdram1_AWADDR  (f2h_sdram1_AWADDR),  //                    .awaddr
		.f2h_sdram1_AWLEN   (f2h_sdram1_AWLEN),   //                    .awlen
		.f2h_sdram1_AWID    (f2h_sdram1_AWID),    //                    .awid
		.f2h_sdram1_AWSIZE  (f2h_sdram1_AWSIZE),  //                    .awsize
		.f2h_sdram1_AWBURST (f2h_sdram1_AWBURST), //                    .awburst
		.f2h_sdram1_AWLOCK  (f2h_sdram1_AWLOCK),  //                    .awlock
		.f2h_sdram1_AWPROT  (f2h_sdram1_AWPROT),  //                    .awprot
		.f2h_sdram1_AWVALID (f2h_sdram1_AWVALID), //                    .awvalid
		.f2h_sdram1_AWCACHE (f2h_sdram1_AWCACHE), //                    .awcache
		.f2h_sdram1_BRESP   (f2h_sdram1_BRESP),   //                    .bresp
		.f2h_sdram1_BID     (f2h_sdram1_BID),     //                    .bid
		.f2h_sdram1_BVALID  (f2h_sdram1_BVALID),  //                    .bvalid
		.f2h_sdram1_BREADY  (f2h_sdram1_BREADY),  //                    .bready
		.f2h_sdram1_ARREADY (f2h_sdram1_ARREADY), //                    .arready
		.f2h_sdram1_AWREADY (f2h_sdram1_AWREADY), //                    .awready
		.f2h_sdram1_RREADY  (f2h_sdram1_RREADY),  //                    .rready
		.f2h_sdram1_RDATA   (f2h_sdram1_RDATA),   //                    .rdata
		.f2h_sdram1_RRESP   (f2h_sdram1_RRESP),   //                    .rresp
		.f2h_sdram1_RLAST   (f2h_sdram1_RLAST),   //                    .rlast
		.f2h_sdram1_RID     (f2h_sdram1_RID),     //                    .rid
		.f2h_sdram1_RVALID  (f2h_sdram1_RVALID),  //                    .rvalid
		.f2h_sdram1_WLAST   (f2h_sdram1_WLAST),   //                    .wlast
		.f2h_sdram1_WVALID  (f2h_sdram1_WVALID),  //                    .wvalid
		.f2h_sdram1_WDATA   (f2h_sdram1_WDATA),   //                    .wdata
		.f2h_sdram1_WSTRB   (f2h_sdram1_WSTRB),   //                    .wstrb
		.f2h_sdram1_WREADY  (f2h_sdram1_WREADY),  //                    .wready
		.f2h_sdram1_WID     (f2h_sdram1_WID),     //                    .wid
		.f2h_sdram1_clk     (f2h_sdram1_clk),     //    f2h_sdram1_clock.clk
		.f2h_sdram2_ARADDR  (f2h_sdram2_ARADDR),  //     f2h_sdram2_data.araddr
		.f2h_sdram2_ARLEN   (f2h_sdram2_ARLEN),   //                    .arlen
		.f2h_sdram2_ARID    (f2h_sdram2_ARID),    //                    .arid
		.f2h_sdram2_ARSIZE  (f2h_sdram2_ARSIZE),  //                    .arsize
		.f2h_sdram2_ARBURST (f2h_sdram2_ARBURST), //                    .arburst
		.f2h_sdram2_ARLOCK  (f2h_sdram2_ARLOCK),  //                    .arlock
		.f2h_sdram2_ARPROT  (f2h_sdram2_ARPROT),  //                    .arprot
		.f2h_sdram2_ARVALID (f2h_sdram2_ARVALID), //                    .arvalid
		.f2h_sdram2_ARCACHE (f2h_sdram2_ARCACHE), //                    .arcache
		.f2h_sdram2_AWADDR  (f2h_sdram2_AWADDR),  //                    .awaddr
		.f2h_sdram2_AWLEN   (f2h_sdram2_AWLEN),   //                    .awlen
		.f2h_sdram2_AWID    (f2h_sdram2_AWID),    //                    .awid
		.f2h_sdram2_AWSIZE  (f2h_sdram2_AWSIZE),  //                    .awsize
		.f2h_sdram2_AWBURST (f2h_sdram2_AWBURST), //                    .awburst
		.f2h_sdram2_AWLOCK  (f2h_sdram2_AWLOCK),  //                    .awlock
		.f2h_sdram2_AWPROT  (f2h_sdram2_AWPROT),  //                    .awprot
		.f2h_sdram2_AWVALID (f2h_sdram2_AWVALID), //                    .awvalid
		.f2h_sdram2_AWCACHE (f2h_sdram2_AWCACHE), //                    .awcache
		.f2h_sdram2_BRESP   (f2h_sdram2_BRESP),   //                    .bresp
		.f2h_sdram2_BID     (f2h_sdram2_BID),     //                    .bid
		.f2h_sdram2_BVALID  (f2h_sdram2_BVALID),  //                    .bvalid
		.f2h_sdram2_BREADY  (f2h_sdram2_BREADY),  //                    .bready
		.f2h_sdram2_ARREADY (f2h_sdram2_ARREADY), //                    .arready
		.f2h_sdram2_AWREADY (f2h_sdram2_AWREADY), //                    .awready
		.f2h_sdram2_RREADY  (f2h_sdram2_RREADY),  //                    .rready
		.f2h_sdram2_RDATA   (f2h_sdram2_RDATA),   //                    .rdata
		.f2h_sdram2_RRESP   (f2h_sdram2_RRESP),   //                    .rresp
		.f2h_sdram2_RLAST   (f2h_sdram2_RLAST),   //                    .rlast
		.f2h_sdram2_RID     (f2h_sdram2_RID),     //                    .rid
		.f2h_sdram2_RVALID  (f2h_sdram2_RVALID),  //                    .rvalid
		.f2h_sdram2_WLAST   (f2h_sdram2_WLAST),   //                    .wlast
		.f2h_sdram2_WVALID  (f2h_sdram2_WVALID),  //                    .wvalid
		.f2h_sdram2_WDATA   (f2h_sdram2_WDATA),   //                    .wdata
		.f2h_sdram2_WSTRB   (f2h_sdram2_WSTRB),   //                    .wstrb
		.f2h_sdram2_WREADY  (f2h_sdram2_WREADY),  //                    .wready
		.f2h_sdram2_WID     (f2h_sdram2_WID),     //                    .wid
		.f2h_sdram2_clk     (f2h_sdram2_clk),     //    f2h_sdram2_clock.clk
		.f2h_irq_p0         (f2h_irq_p0),         //            f2h_irq0.irq
		.f2h_irq_p1         (f2h_irq_p1)          //            f2h_irq1.irq
	);

	Kvazaar_QSYS_hps_0_hps_io hps_io (
