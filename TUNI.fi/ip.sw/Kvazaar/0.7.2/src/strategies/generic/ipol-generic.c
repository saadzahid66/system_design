...
void kvz_get_extended_block_generic(int xpos, int ypos, int mv_x, int mv_y, int off_x, int off_y, kvz_pixel *ref, int ref_width, int ref_height,
  ...
  if (sample_out_of_bounds){
    out->buffer = (kvz_pixel*)MALLOC(kvz_pixel, (width + filter_size) * (width + filter_size));
    if (!out->buffer){
...
int kvz_strategy_register_ipol_generic(void* opaque, uint8_t bitdepth)
{
  ...
  success &= kvz_strategyselector_register(opaque, "filter_inter_quarterpel_luma", "generic", 0, (void*)&kvz_filter_inter_quarterpel_luma_generic);
  success &= kvz_strategyselector_register(opaque, "filter_inter_halfpel_chroma", "generic", 0, (void*)&kvz_filter_inter_halfpel_chroma_generic);
  success &= kvz_strategyselector_register(opaque, "filter_inter_octpel_chroma", "generic", 0, (void*)&kvz_filter_inter_octpel_chroma_generic);
  success &= kvz_strategyselector_register(opaque, "get_extended_block", "generic", 0, (void*)&kvz_get_extended_block_generic);
