...
int kvz_strategy_register_dct_generic(void* opaque, uint8_t bitdepth)
{
  ...
  success &= kvz_strategyselector_register(opaque, "fast_forward_dst_4x4", "generic", 0, (void*)&fast_forward_dst_4x4_generic);
  
  success &= kvz_strategyselector_register(opaque, "dct_4x4", "generic", 0, (void*)&dct_4x4_generic);
  success &= kvz_strategyselector_register(opaque, "dct_8x8", "generic", 0, (void*)&dct_8x8_generic);
  success &= kvz_strategyselector_register(opaque, "dct_16x16", "generic", 0, (void*)&dct_16x16_generic);
  success &= kvz_strategyselector_register(opaque, "dct_32x32", "generic", 0, (void*)&dct_32x32_generic);

  success &= kvz_strategyselector_register(opaque, "fast_inverse_dst_4x4", "generic", 0, (void*)&fast_inverse_dst_4x4_generic);

  success &= kvz_strategyselector_register(opaque, "idct_4x4", "generic", 0, (void*)&idct_4x4_generic);
  success &= kvz_strategyselector_register(opaque, "idct_8x8", "generic", 0, (void*)&idct_8x8_generic);
  success &= kvz_strategyselector_register(opaque, "idct_16x16", "generic", 0, (void*)&idct_16x16_generic);
  success &= kvz_strategyselector_register(opaque, "idct_32x32", "generic", 0, (void*)&idct_32x32_generic);
  return success;
}
