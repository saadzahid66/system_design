...
int kvz_strategy_register_nal_generic(void* opaque, uint8_t bitdepth) {
  ...
  success &= kvz_strategyselector_register(opaque, "array_checksum", "generic", 0, (void*)&array_checksum_generic);
  success &= kvz_strategyselector_register(opaque, "array_checksum", "generic4", 1, (void*)&array_checksum_generic4);
  success &= kvz_strategyselector_register(opaque, "array_checksum", "generic8", 2, (void*)&array_checksum_generic8);
